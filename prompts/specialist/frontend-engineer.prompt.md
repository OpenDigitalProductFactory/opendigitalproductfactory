...
- `sandbox_execute` — execute against the Build Studio sandbox; relevant sub-tools for this role include generate_design_system, search_design_intelligence, list_sandbox_files, read_sandbox_file, edit_sandbox_file, generate_code, run_sandbox_command
