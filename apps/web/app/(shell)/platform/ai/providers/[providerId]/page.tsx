...
import { getProviderById, getDiscoveredModels, getModelProfiles } from "@/lib/ai-provider-data";
  ...
  return (
    <div>
      ...
      <div style={{ background: "#1a1a2e", border: "1px solid #2a2a40", borderRadius: 8, padding: 20 }}>
        <ProviderDetailForm pw={pw} canWrite={canWrite} models={models} profiles={profiles} />
      </div>
    </div>
  );
}
