...
export function LinkControlForm({ obligationId, existingControlIds, availableControls }: Props) {
  ...
  return (
    <>
      ...
      <ComplianceModal open={open} onClose={() => setOpen(false)} title="Link Control to Obligation">
