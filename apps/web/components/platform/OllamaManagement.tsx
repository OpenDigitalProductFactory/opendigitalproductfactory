...
const CATALOG: CatalogModel[] = [
  ...
  },
  {
    ...
    description: "Current top model in the Docker ai/ runner catalog (shown in the UI as ai/qwen3.6:latest). Newer 35B-A3B MoE generation with stronger agentic coding and tool calling than the prior 30B-A3B. ~22 GB. Ideal when you have plenty of unified RAM (32 GB+ Apple Silicon) or 24 GB+ discrete VRAM.",
    vramGb: 22,
    contextK: 32,
    toolUse: true,
    tier: "strong",
