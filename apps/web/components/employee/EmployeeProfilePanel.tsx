      ...
      {!employee ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="rounded-md border border-[var(--dpf-border)] bg-[var(--dpf-surface-2)] p-3 space-y-2">
            ...
            <p className="text-base font-semibold text-[var(--dpf-text)]">{employee.displayName}</p>
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
              <div>
                ...
                <dd className="text-[var(--dpf-text)]">{employee.workEmail ?? "Not set"}</dd>
              </div>
              <div>
              ...
              <div>
                ...
                <dd className="text-[var(--dpf-text)]">{employee.timezone ?? "Not set"}</dd>
              </div>
            </dl>
          </div>
          ...
          <div className="rounded-md border border-[var(--dpf-border)] bg-[var(--dpf-surface-2)] p-3">
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
              <div>
                ...
                <dd className="text-[var(--dpf-text)]">{employee.status}</dd>
              </div>
              <div>
          ...
          <div className="col-span-full rounded-md border border-[var(--dpf-border)] bg-[var(--dpf-surface-2)] p-3 space-y-2">
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
              <div>
                ...
                <dd className="text-[var(--dpf-text)]">{employee.phoneWork ?? "Not set"}</dd>
              </div>
              <div>
                <dt className="text-[10px] uppercase tracking-widest text-[var(--dpf-muted)]">Mobile Phone</dt>
                <dd className="text-[var(--dpf-text)]">{employee.phoneMobile ?? "Not set"}</dd>
              </div>
              <div>
                <dt className="text-[10px] uppercase tracking-widest text-[var(--dpf-muted)]">Emergency Phone</dt>
                <dd className="text-[var(--dpf-text)]">{employee.phoneEmergency ?? "Not set"}</dd>
              </div>
            </dl>
            {primaryAddress && (
              <div className="text-xs mt-2">
                <dt className="text-[10px] uppercase tracking-widest text-[var(--dpf-muted)]">Primary Address</dt>
                <dd className="text-[var(--dpf-text)] mt-0.5">{formatAddress(primaryAddress.address)}</dd>
              </div>
            )}
          </div>
        </div>
