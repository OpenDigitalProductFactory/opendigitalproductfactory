...
export const AREA_META: Record<string, { label: string; description: string }> = {
  ...
  complaints:        { label: "Complaints", description: "Complaint intake, triage, and resolution workflows" },
  ...
  inventory:         { label: "Inventory", description: "Operational inventory, discovered infrastructure, and managed items" },
  knowledge:         { label: "Knowledge", description: "Internal articles, guidance, and reusable operational knowledge" },
  platform:          { label: "Platform", description: "Platform tools, services, identity, audit, and integration administration" },
