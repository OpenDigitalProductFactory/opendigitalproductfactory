  ...
  "anthropic-sub": [
    {
      ...
      summary:
        "Anthropic Claude Sonnet 4.6 — strong reasoning and coding fallback when governed custom tool execution is not required",
      ...
      costTier: "$$",
      bestFor: ["code generation", "complex reasoning", "analysis"],
      avoidFor: ["custom MCP tool use"],
    ...
    },
    {
      ...
      summary:
        "Anthropic Claude Opus 4.6 — deep reasoning fallback when governed custom tool execution is not required",
      qualityTier: "frontier",
      capabilities: {
        ...EMPTY_CAPABILITIES,
        toolUse: false,
    ...
    },
    {
      ...
      costTier: "$",
      bestFor: ["general purpose tasks", "fast responses"],
      avoidFor: ["complex code generation", "deep reasoning", "custom MCP tool use"],
      defaultStatus: "active",
      scores: {
        reasoning: 75,
        codegen: 75,
