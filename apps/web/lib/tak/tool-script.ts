...
export function wrapToolScript(userCode: string, opts?: { portalUrl?: string }): string {
  ...
  return [
    ...
    `    method: "POST",`,
    `    headers: { "content-type": "application/json", "X-MCP-Session": TOKEN, "MCP-Protocol-Version": "2026-07-28", "Mcp-Method": "tools/call", "Mcp-Name": name },`,
    `    body: JSON.stringify({ jsonrpc: "2.0", id: ++__mcpId, method: "tools/call", params: { name, arguments: args || {}, _meta: { "io.modelcontextprotocol/protocolVersion": "2026-07-28", "io.modelcontextprotocol/clientInfo": { name: "dpf-ai-coworker-tool-script", version: "1.0.0" }, "io.modelcontextprotocol/clientCapabilities": { extensions: { "io.modelcontextprotocol/tasks": {} } } } } }),`,
    `  });`,
