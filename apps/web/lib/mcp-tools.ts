...
export const PLATFORM_TOOLS: ToolDefinition[] = [
  ...
  // assess_contribution + contribute_to_hive moved to mcp/packs/contribution-hive-pack.ts
  {
    name: "run_ux_test",
  ...
  // ─── Feedback Loop ──────────────────────────────────────────────────────────
  // propose_improvement + propose_skill_improvement moved to mcp/packs/contribution-hive-pack.ts
  // ─── Provider Management ────────────────────────────────────────────────────
  {
    name: "add_provider",
  ...
  // submit_feedback moved to mcp/packs/contribution-hive-pack.ts
...
export async function executeTool(
  ...
  switch (toolName) {
    ...
    // propose_improvement + propose_skill_improvement cases moved to mcp/packs/contribution-hive-pack.ts
