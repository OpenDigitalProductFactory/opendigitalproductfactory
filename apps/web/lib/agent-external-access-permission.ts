...
export function buildExternalAccessDisabledInstruction(
  ...
  return [
    ...
    "The employee request appears to need public web or official-source verification, but Web access is OFF for this page and session.",
    ...
    "Instead, ask the employee to turn on **Web access** using the Controls switch next to the message box (the coworker posture control in the chat composer).",
    "Explain why live web research needs that switch, in plain language, and name the first public sources or search targets you will check once it is on.",
    "If they also need a marketing integration (e.g. google-marketing-intelligence), say so and point them at Platform integrations — but lead with the Web access switch first.",
    "Preserve the task context so the employee can enable Web access and continue in this thread.",
