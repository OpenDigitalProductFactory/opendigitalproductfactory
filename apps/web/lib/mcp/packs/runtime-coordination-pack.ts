...
const definitions: ToolDefinition[] = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        workCapsuleId: { type: "string", description: "Optional internal Workroom row id; prefer capsuleId for external agents." },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        workCapsuleId: { type: "string", description: "Optional Workroom row id; prefer capsuleId for external agents." },
        buildId: { type: "string", description: "Optional semantic FeatureBuild id (FB-*)." },
        ...
        capsuleActivityId: { type: "string", description: "WorkroomActivity row id." },
