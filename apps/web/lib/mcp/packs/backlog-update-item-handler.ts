// update_backlog_item MCP handler (extracted from mcp-tools.ts; relocated from
// the abandoned lib/mcp-handlers/ third-generation home into the pack layer —
// Simplify & Strengthen W9, BI-0E7B0953).
//
