...
async function listScheduledAgentTasksHandler(userId: string): Promise<ToolResult> {
...
const handlers: Record<string, ToolPackHandler> = {
  ...
  list_scheduled_agent_tasks: (_params, userId) => listScheduledAgentTasksHandler(userId),
