...
vi.mock("@/lib/build/investment-admission", async (importOriginal) => ({ blocksStart: (await importOriginal<typeof import("@/lib/build/investment-admission")>()).blocksStart, evaluateItemAdmission: async () => ({ verdict: "admit", reason: "fits" }), recordAdmissionOutcome: async () => undefined })); // BI-3430B3A4
