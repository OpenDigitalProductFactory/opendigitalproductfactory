...
export const COWORKER_STANDING_SELF_TASKS: Record<string, CoworkerSelfTask> = {
  ...
  "evaluate-orchestrator": task(
    "Survey and route the evaluate stream", "/build/work", "3 6 * * 1", "3 6 * * 1,4",
    [
      "Goal: nothing in the evaluate stream sits unowned without someone knowing.",
      "1. Read every open item in the stream — scored candidates and what is worth doing next.",
      "2. Route what belongs to a named specialist, with the context already gathered.",
      "3. Surface anything with NO owner as unowned. An unowned item quietly retained by",
      "   the orchestrator is the failure this cycle exists to prevent.",
      "4. Propose a direction for the stream. You coordinate; the stream owner decides.",
      "If the stream cannot be read, report that and stop — an empty survey is not a quiet",
      "stream.",
    ],
  ),
  "explore-orchestrator": task(
    "Survey and route the explore stream", "/build/work", "5 6 * * 1", "5 6 * * 1,4",
    [
      "Goal: nothing in the explore stream sits unowned without someone knowing.",
      "1. Read every open item in the stream — open research and the options it has produced.",
      "2. Route what belongs to a named specialist, with the context already gathered.",
      "3. Surface anything with NO owner as unowned. An unowned item quietly retained by",
      "   the orchestrator is the failure this cycle exists to prevent.",
      "4. Propose a direction for the stream. You coordinate; the stream owner decides.",
  ...
  "integrate-orchestrator": task(
    "Survey and route the integrate stream", "/build/work", "7 6 * * 1-5", "7 6,15 * * *",
    [
      "Goal: nothing in the integrate stream sits unowned without someone knowing.",
      "1. Read every open item in the stream — in-flight build work and its blockers.",
      "2. Route what belongs to a named specialist, with the context already gathered.",
      "3. Surface anything with NO owner as unowned. An unowned item quietly retained by",
      "   the orchestrator is the failure this cycle exists to prevent.",
      "4. Propose a direction for the stream. You coordinate; the stream owner decides.",
  ...
  "deploy-orchestrator": task(
    "Survey and route the deploy stream", "/ops", "9 6 * * 1-5", "9 6,15 * * *",
    [
      "Goal: nothing in the deploy stream sits unowned without someone knowing.",
      "1. Read every open item in the stream — promotion candidates and their gate state.",
      "2. Route what belongs to a named specialist, with the context already gathered.",
      "3. Surface anything with NO owner as unowned. An unowned item quietly retained by",
      "   the orchestrator is the failure this cycle exists to prevent.",
      "4. Propose a direction for the stream. You coordinate; the stream owner decides.",
  ...
  "release-orchestrator": task(
    "Survey and route the release stream", "/ops", "11 7 * * 1-5", "11 7,16 * * *",
    [
      "Goal: nothing in the release stream sits unowned without someone knowing.",
      "1. Read every open item in the stream — release bundles and their validation state.",
      "2. Route what belongs to a named specialist, with the context already gathered.",
      "3. Surface anything with NO owner as unowned. An unowned item quietly retained by",
      "   the orchestrator is the failure this cycle exists to prevent.",
      "4. Propose a direction for the stream. You coordinate; the stream owner decides.",
  ...
  "consume-orchestrator": task(
    "Survey and route the consume stream", "/customer", "13 7 * * 1-5", "13 7,16 * * *",
    [
      "Goal: nothing in the consume stream sits unowned without someone knowing.",
      "1. Read every open item in the stream — customer-facing delivery and open demand.",
      "2. Route what belongs to a named specialist, with the context already gathered.",
      "3. Surface anything with NO owner as unowned. An unowned item quietly retained by",
      "   the orchestrator is the failure this cycle exists to prevent.",
      "4. Propose a direction for the stream. You coordinate; the stream owner decides.",
  ...
  "operate-orchestrator": task(
    "Survey and route the operate stream", "/ops", "15 7 * * *", "15 7,13,19 * * *",
    [
      "Goal: nothing in the operate stream sits unowned without someone knowing.",
      "1. Read every open item in the stream — run-state, incidents, and service health.",
      "2. Route what belongs to a named specialist, with the context already gathered.",
      "3. Surface anything with NO owner as unowned. An unowned item quietly retained by",
      "   the orchestrator is the failure this cycle exists to prevent.",
      "4. Propose a direction for the stream. You coordinate; the stream owner decides.",
  ...
  "governance-orchestrator": task(
    "Survey and route the governance stream", "/govern", "17 8 * * 1", "17 8 * * 1,4",
    [
      "Goal: nothing in the governance stream sits unowned without someone knowing.",
      "1. Read every open item in the stream — policy posture, compliance state, and open decisions.",
      "2. Route what belongs to a named specialist, with the context already gathered.",
      "3. Surface anything with NO owner as unowned. An unowned item quietly retained by",
      "   the orchestrator is the failure this cycle exists to prevent.",
      "4. Propose a direction for the stream. You coordinate; the stream owner decides.",
  ...
  "finance-agent": task(
    "Report the money position", "/finance", "19 8 * * *", "19 8,17 * * *",
    [
      "Goal: the owner is never surprised by their own money.",
      "1. Read recorded invoices, bills, expenses and balances.",
      "2. Report burn and revenue where they are measurable, saying what window they cover.",
      "3. For anything NOT measurable, say exactly what would have to be recorded to make",
      "   it known. Never present an absent number as zero, and never invent an amount.",
      "An honest 'unknown, here is what to record' is the deliverable when the books are",
      "thin.",
    ],
  ),
};
