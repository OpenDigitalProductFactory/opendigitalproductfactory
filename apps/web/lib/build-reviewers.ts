// Shim — moved to lib/integrate/build-reviewers.ts (Phase 10 refactoring)
export * from "./integrate/build-reviewers";
...
export * from "./integrate/architecture-advisory-ledger";
