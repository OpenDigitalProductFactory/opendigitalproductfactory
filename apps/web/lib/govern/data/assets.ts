...
const SEED_ASSETS: readonly DataAssetDefinition[] = [
  ...
  ...[
    ...
    ownerRole: "founder-business-owner",
    stewardRole: "data-steward",
    categories: ["operational", "financial"] as DataCategory[],
    sensitivity: "internal" as DataSensitivity,
    criticality: "high" as DataCriticality,
    subjectLocators: [
      { role: "organization" as const, fieldPath: "organization" },
  ...
  ...[
    ...
    ["data:business-product-fulfillment-instance", "ProductFulfillmentInstance"],
  ].map(([id, prismaModel]) => ({
    id: id as DataAssetId,
    physical: { prismaModel },
    domain: "business-product-portfolio",
    ownerRole: "founder-business-owner",
    stewardRole: "data-steward",
    categories: ["customer", "operational"] as DataCategory[],
    sensitivity: "confidential" as DataSensitivity,
    criticality: "high" as DataCriticality,
    subjectLocators: [
      { role: "organization" as const, fieldPath: "organization" },
