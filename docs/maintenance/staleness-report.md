...
| `docs/founder-kernel/wiki/principles/mirror-dont-migrate.md` | 21d | `docs/founder-kernel/wiki/principles/never-wipe-db-for-code-fixes.md` (+21d)<br>`docs/founder-kernel/wiki/principles/schema-honesty-over-aspirational-naming.md` (+21d)<br>`docs/founder-kernel/wiki/principles/one-data-model.md` (+0d)<br>…+1 more |
