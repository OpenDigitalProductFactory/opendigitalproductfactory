...
**206 of 701 published doc pages (29.4%) carry a doc-impact edge.**
The other **495** (70.6%) carry none, and are invisible to
...
Of those 495, **480 reference no repo file anywhere in their text** — no link, no
...
The timestamp detector (`build-docs-staleness.mjs`, BI-AA5DFEA2) currently reports **162** stale
...
1. **Widening is close to exhausted.** Of the pages any code-edge derivation could
   reach, 206 of 221 (93.2%) now carry an edge. The headline 29.4% understates
