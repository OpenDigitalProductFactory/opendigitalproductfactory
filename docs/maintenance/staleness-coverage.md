...
**200 of 685 published doc pages (29.2%) carry a doc-impact edge.**
The other **485** (70.8%) carry none, and are invisible to
...
Of those 485, **469 reference no repo file anywhere in their text** — no link, no
...
The timestamp detector (`build-docs-staleness.mjs`, BI-AA5DFEA2) currently reports **169** stale
...
1. **Widening is close to exhausted.** Of the pages any code-edge derivation could
   reach, 200 of 216 (92.6%) now carry an edge. The headline 29.2% understates
