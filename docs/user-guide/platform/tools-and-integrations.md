...
1. Identify whether you are managing a tool definition, a service endpoint, a native integration, or an integration connection.
2. Confirm the catalog or inventory state before trying to activate or troubleshoot anything.
3. Use the platform-specific route when you need system posture; use the domain route when you need business workflow context.
4. Treat native integration previews as operational evidence only when the connected provider account, permissions, and freshness are visible.
