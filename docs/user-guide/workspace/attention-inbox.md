...
- Ask your [AI coworker](../getting-started/ai-coworker.md) for a briefing on what is in the inbox and why.
...
*Derived from the design spec [The Attention Surface — a kernels-first "Needs you" inbox](https://github.com/OpenDigitalProductFactory/opendigitalproductfactory/blob/main/docs/superpowers/specs/2026-06-23-human-attention-surface-design.md). This user guide is the operator-facing view; the spec holds the full rationale and non-goals.*
