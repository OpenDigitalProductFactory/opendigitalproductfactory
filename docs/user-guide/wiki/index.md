...
The **Waiting on your call** list is the single inbox for unanswered business decisions, whichever business area raised them. A funding question from Demand and a question raised directly by a coworker arrive here through the same organization decision profile. Build, task, and platform-governance decisions keep their own governed paths instead of leaking into this owner inbox.
