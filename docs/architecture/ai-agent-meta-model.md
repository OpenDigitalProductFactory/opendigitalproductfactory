...
```
*Editable source: [`agent-meta-model-diagrams/01-agent-composition.mmd`](agent-meta-model-diagrams/01-agent-composition.mmd)*
...
flowchart LR
    ...
    class AIDOC d
```
*Editable source: [`agent-meta-model-diagrams/02-identity-projection.mmd`](agent-meta-model-diagrams/02-identity-projection.mmd)*
...
flowchart TB
    ...
    class GATE gate
```
*Editable source: [`agent-meta-model-diagrams/03-runtime-assembly.mmd`](agent-meta-model-diagrams/03-runtime-assembly.mmd)*
