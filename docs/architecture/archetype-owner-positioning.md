...
**Scope:** Owner-facing marketing opportunity, visual direction, and test-priority translation for the current 106 archetypes across 24 categories.
...
| Agriculture and ranching | The owner is simultaneously planner, stockperson, equipment manager, buyer, seller, regulator-facing operator, and coordinator of weather-dependent outside work. | DPF turns fields, pastures, herds, working animals, machinery, supplies, providers, obligations, and dated signals into one Now / Next / Season attention horizon while keeping consequential judgment with the owner and qualified specialists. | Map-led whole-operation view with fields/pastures, herd groups, equipment readiness, hay/service windows, care appointments, and source-dated weather/market/regulatory evidence. | Map/list parity, horse-as-animal semantics, seasonal dependencies, dealer/custom-operator readiness, source freshness, jurisdiction, and approval gates for clinical, chemical, legal, financial, messaging, spending, and machinery actions are release-critical. |
