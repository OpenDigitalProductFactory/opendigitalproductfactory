...
- `architecture-over-shortcuts` (commandment) — the underlying *why* this principle defaults to proper. This principle is the operating contract that makes that commandment hold day-to-day.
