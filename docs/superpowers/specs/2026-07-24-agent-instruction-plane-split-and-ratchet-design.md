...
Ordering is by dependency and blast radius; each phase is independently shippable and independently valuable. **Prerequisite (§8): BI-ACC7A2B5's assumption-marking on `AGENTS.md` merges before Phase 1.**
