...
2. **Boot invariants catch drift before it ships.** Any change to `PLATFORM_TOOLS`, `TOOL_TO_GRANTS`, agent registry, or pricing that violates an invariant fails CI. Drift is structurally hard.
