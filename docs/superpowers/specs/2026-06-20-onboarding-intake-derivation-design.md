...
| **P4 ◑ roster slice shipped** | **Document lane** | **Slice 1 (done):** employee-roster CSV → parse → preview → confirm → create `EmployeeProfile` (identity baseline), on the existing business-context page (no new page route — nav-refactor-safe). **Sequenced:** XLSX-direct, formation-packet fan-out (legal name/EIN → Organization/License/Tax), Department/Position FK resolution. | file-parsers; bulk-import spec |
...
**Status:** P0 (risk-posture home), P1 (autonomy-gate keystone), P1.2-first-knob (capability auto-activate), and P4-slice-1 (employee-roster CSV) shipped. Plans: [P0](plans/2026-06-20-onboarding-risk-posture-p0.md), [P1](plans/2026-06-20-onboarding-risk-posture-p1.md), [P1.2](plans/2026-06-20-onboarding-risk-posture-p1-2.md), [P4 roster](plans/2026-06-22-onboarding-document-lane-roster.md). Surface-heavy layers (P2 trust panel, P3 QuickBooks, rest of P4) sequence with the EP-NAV-COHERENCE refactor; remaining P1.2 knobs under BI-E93A3437; outbound-strictness deferred.
