...
- **Date:** 2026-08-02
- Backlog item (does NOT resolve in this install — treat as a label, not a link): BI-97E5582F — Operations Map progressive disclosure switched off, cannot answer why routing degraded
- **Epic:** EP-AI-OPSMAP
...
> - Preserved implementation: `fix/operations-map-owner-first` @ `e62a13a758e1f6c2a49e813fc1af19ec6c59cd13`, pinned at `refs/salvage/2026-08-15/fix/operations-map-owner-first` and listed in `~/dpf-deleted-remote-branch-tips-2026-08-15.txt`. Restore with `git push origin e62a13a758e1f6c2a49e813fc1af19ec6c59cd13:refs/heads/fix/operations-map-owner-first`.
> - Backlog ids cited below that do **not** resolve in this install: `BI-3006D674`, `BI-97E5582F`. Treat them as labels, not links.
