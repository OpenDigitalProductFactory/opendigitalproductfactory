...
- [ ] **Step 4: Classify default topology honestly.** Only PostgreSQL, portal initialization, and portal remain universal core. Existing always-on build, browser, speech, execution, and telemetry services become capability-activated and receive Compose profiles in Task 4; no container is deleted in this slice.
