...
| Field | Value |
|-------|-------|
| **Status** | **GOVERNED.** Umbrella BI filed and a live `record_plan_backlog_coverage` receipt exists (see `## Backlog coverage`). Kernel-ratified now-vs-later sequencing recorded (`DI-A573E0551352`). |
