...
| Phase | Deliverable | Backlog item | Objectives served |
| --- | --- | --- | --- |
| 1 | Membership material, sign relay, import action, import tool | BI-4DD1E739 | OBJ-MEMBERSHIP-ONLY-SWITCH, OBJ-PORTAL-MEDIATED |
| 2 | Join-file issuance, trusted-peer picker, membership-proof pairing | BI-105BB8B2, BI-1F69D3F8, BI-AC7BCC58 | OBJ-PORTAL-MEDIATED, OBJ-BORN-TRUSTED, OBJ-SESSION-FREE-PARITY |
| 3 | Edge-node path retired from the Connections page | BI-66A2DFB3 | OBJ-MEMBERSHIP-ONLY-SWITCH |
