...
- [Cloud Deployment Design](docs/superpowers/specs/2026-05-09-cloud-deployment-design.md) — substrates (Single VM, Managed container service, Managed Kubernetes) and packaging targets (TAPPaaS module, marketplace image, Helm chart, Terraform modules). Single-VM substrate operator runbook: [docs/install/cloud-single-vm.md](docs/install/cloud-single-vm.md) (early access — AWS / GCP / Azure pilots wanted).
