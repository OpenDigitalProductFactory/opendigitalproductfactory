...
- **Absorb, don't adopt; the dependency surface only shrinks.** An added package, image, service or subscription must retire more than it adds. **Commandment tier.** → [kernel principle](docs/founder-kernel/wiki/principles/absorb-dont-adopt.md)
