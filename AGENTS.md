...
- **Governance must earn its cost.** Reuse relevant evidence and authorization; a phase change alone needs no fresh consent. Gates serve a decision or protection, never ceremony. See [evidence doctrine](docs/founder-kernel/wiki/principles/governance-approves-evidence-not-provenance.md).
