...
export interface ArchetypeDefinition {
  ...
  /**
   * Optional Mailroom profile: which mailboxes a business of this kind runs,
   * why a stranger writes to it, how urgent each reason is, and which standing
   * queue owns it. Merged over the common profile at resolution time, so an
   * archetype contributes lanes rather than restating the universal ones. See
   * docs/superpowers/specs/2026-09-09-mailroom-email-triage-and-dispatch-design.md §4.2.
   */
  mailroomProfile?: MailroomProfile;
}
