...
const PROFILES: Record<string, FinancialProfileSeed> = {
  ...
  manufacturing: {
    archetypeCategory: "manufacturing",
    displayName: "Manufacturing & Industrial OEM",
    defaultPaymentTerms: "Net 30",
    defaultCurrency: "USD",
    vatRegistered: false,
    defaultTaxRate: 0,
    ...
    chartOfAccountsSeed: [
      ...
      { code: "1210", name: "Work in Process Inventory", type: "asset" },
      { code: "1220", name: "Finished Goods Inventory", type: "asset" },
      { code: "4000", name: "Product Revenue", type: "revenue" },
      { code: "4010", name: "Spares & Lifecycle Support Revenue", type: "revenue" },
      { code: "5000", name: "Direct Materials", type: "expense" },
      { code: "5010", name: "Direct Labour", type: "expense" },
      { code: "5020", name: "Manufacturing Overhead", type: "expense" },
      { code: "5030", name: "Freight & Packaging", type: "expense" },
    ],
  },
