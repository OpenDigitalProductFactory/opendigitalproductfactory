...
const PROFILES: Record<string, FinancialProfileSeed> = {
  ...
  banking_financial_services: {
    ...
    chartOfAccountsSeed: [
      ...
      { code: "4020", name: "Service Charges & Account Fees", type: "revenue" },
      { code: "4030", name: "Card Interchange Income", type: "revenue" },
      { code: "4040", name: "Loan Origination Fees", type: "revenue" },
      { code: "5000", name: "Interest Expense — Deposits", type: "expense" },
      { code: "5010", name: "Provision for Loan Losses", type: "expense" },
      { code: "5020", name: "Deposit Insurance Premiums", type: "expense" },
      { code: "5030", name: "Core Processing & Technology", type: "expense" },
      { code: "5040", name: "Regulatory & Examination Fees", type: "expense" },
    ],
