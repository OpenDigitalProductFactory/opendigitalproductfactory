...
const REQUIREMENTS: ElementSeed[] = [
  ...
  { key: "req:REQ-DATA-3", typeSlug: "requirement", name: "REQ-DATA-3 Every mirrored node carries a stable source key", description: "Element key prisma:model:<Model>; relationship key prisma:relation:<From>:<field>:<To>. Stored in properties.sourceKey and the infraCiKey column, denormalized onto the Neo4j node.", properties: det("apps/web/lib/ea/data-model-mirror.ts#L23-37; data-model-mirror-apply.ts#L210") },
