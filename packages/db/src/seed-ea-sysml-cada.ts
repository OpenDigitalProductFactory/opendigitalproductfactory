...
const PARTS: Array<ElementSeed & { satisfies: string[] }> = [
  ...
  { key: "part:jurisdiction", typeSlug: "part_definition", name: "Jurisdiction model", description: "Business-context fields for operating, selling, employing, and data-residency footprint.", properties: det("packages/db/prisma/schema.prisma#BusinessContext"), satisfies: ["req:REQ-CADA-6"] },
