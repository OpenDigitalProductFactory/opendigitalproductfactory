...
| [`dpf-worktree-hygiene`](skills/dpf-worktree-hygiene/SKILL.md) | dpf-worktree-per-session (predecessor) | `["build-specialist", "platform-engineer", "ops-coordinator"]` | Session reaper vs flag-gated fleet soak; dry-run default; live Tier-A / sandbox GC only with explicit go; junction-safe remove |
